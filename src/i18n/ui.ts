...
export const ui = {
  ...
  loadError: {
    ...
    en: 'Failed to load content. Please refresh the page.',
    de: 'Inhalt konnte nicht geladen werden. Bitte Seite neu laden.',
    es: 'No se pudo cargar el contenido. Actualiza la página.',
  },
  emptyContent: {
